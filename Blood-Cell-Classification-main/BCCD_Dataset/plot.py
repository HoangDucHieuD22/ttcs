...
[image_names, numberOfFiles] = filterFiles(r"C:\Users\ADMIN\OneDrive\Documents\Code\TTCS\Blood-Cell-Classification-main\BCCD_Dataset\BCCD\JPEGImages", "jpg")    
...
for imageFileName in image_names:    
    ...
    image = plt.imread('C:/Users/ADMIN/OneDrive/Documents/Code/TTCS/Blood-Cell-Classification-main/BCCD_Dataset/BCCD/JPEGImages/' + imageFileName)
    plt.imshow(image)
